...
class LaratrustSeeder extends Seeder
{
        ...
        foreach ($config as $key => $modules) {
            ...
            foreach ($modules as $module => $value) {
                ...
                foreach ($permissions as $p => $perm) {
                    ...
                    $permission = \App\Models\Admin\Permission::firstOrCreate([
    ...
    public function truncateLaratrustTables()
    {
        ...
        $usersTable = (new \App\Models\Admin\User)->getTable();
        $rolesTable = (new \App\Models\Admin\Role)->getTable();
        $permissionsTable = (new \App\Models\Admin\Permission)->getTable();
